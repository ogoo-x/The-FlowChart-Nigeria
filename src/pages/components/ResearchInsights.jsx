  ...
  return (
    <div className="mt-10 w-full content">
                ...
                <div className="mt-6 flex justify-end">
                  <button 
                    ...
                    onClick={(e) => {
                      ...
                      window.open(`https://example.com/articles/${article.id}`, '_blank');
                    }}
                  >
      ...
      <div className="mt-8 p-4 bg-rose-50 rounded-lg border border-custom-red">
        ...
        <Mailto email="theflowchartnig@gmail.com" subject="Re:Research Team" body="I would like to enquire/collaborate">
        <button className="mt-4 bg-rose-700 text-white px-4 py-2 rounded hover:bg-rose-800 transition-colors">
